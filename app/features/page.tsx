      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 max-w-4xl mx-auto">
            <h3 className="text-lg font-bold text-blue-900 mb-3">🎯 Yang OASIS BI PRO Lakukan:</h3>
            <ul className="space-y-2 text-blue-800">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5 text-blue-600" />
                <span><strong>Mengumpulkan & Mengintegrasikan Data</strong> dari berbagai sumber (Google Analytics, Shopee, Tokopedia, Database, dll) ke dalam satu platform terpusat</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5 text-blue-600" />
                <span><strong>Memvisualisasikan Data</strong> dalam bentuk charts, graphs, dan dashboards interaktif yang mudah dipahami</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5 text-blue-600" />
                <span><strong>Menganalisis dengan AI</strong> untuk mendeteksi anomali, forecast revenue, prediksi churn, dan memberikan rekomendasi otomatis</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5 text-blue-600" />
                <span><strong>Menyediakan Insights Actionable</strong> yang membantu bisnis membuat keputusan lebih cerdas berdasarkan data</span>
              </li>
            </ul>
          </div>
        </div>
